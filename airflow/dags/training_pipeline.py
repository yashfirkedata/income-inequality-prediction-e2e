...
from src.IncomeInequalityPrediction.pipelines.training_pipeline import TrainingPipeline

training_pipeline=TrainingPipeline()

with DAG(
    "inequality_training_pipeline",
    ...
    start_date=pendulum.datetime(2024, 5, 23, tz="UTC"),
    catchup=False,
    tags=["machine_learning ","classification","income_inequality","training_pipeline"]
) as dag:
